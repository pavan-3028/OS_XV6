...
int main() {
  ...
  pipe(fd);
   ...
   c:	314000ef          	jal	320 <pipe>
  
  int pid = fork();
  10:	2f8000ef          	jal	308 <fork>
  if(pid == 0) {
  14:	e50d                	bnez	a0,3e <main+0x3e>
    close(fd[0]);
  16:	fe842503          	lw	a0,-24(s0)
  1a:	31e000ef          	jal	338 <close>
    write(fd[1], "Hello via pipe!", 15);
  1e:	463d                	li	a2,15
  20:	00001597          	auipc	a1,0x1
  24:	8d058593          	addi	a1,a1,-1840 # 8f0 <malloc+0x104>
  28:	fec42503          	lw	a0,-20(s0)
  2c:	304000ef          	jal	330 <write>
    close(fd[1]);
  30:	fec42503          	lw	a0,-20(s0)
  34:	304000ef          	jal	338 <close>
    exit(0);
  38:	4501                	li	a0,0
  3a:	2d6000ef          	jal	310 <exit>
  } else {
    close(fd[1]);
  3e:	fec42503          	lw	a0,-20(s0)
  42:	2f6000ef          	jal	338 <close>
    read(fd[0], buf, 15);
  46:	463d                	li	a2,15
  48:	fd040593          	addi	a1,s0,-48
  4c:	fe842503          	lw	a0,-24(s0)
  50:	2d8000ef          	jal	328 <read>
    write(1, buf, 15);
  54:	463d                	li	a2,15
  56:	fd040593          	addi	a1,s0,-48
  5a:	4505                	li	a0,1
  5c:	2d4000ef          	jal	330 <write>
    write(1, "\n", 1);
  60:	4605                	li	a2,1
  62:	00001597          	auipc	a1,0x1
  66:	89e58593          	addi	a1,a1,-1890 # 900 <malloc+0x114>
  6a:	4505                	li	a0,1
  6c:	2c4000ef          	jal	330 <write>
    wait(0);
  70:	4501                	li	a0,0
  72:	2a6000ef          	jal	318 <wait>
  }
  exit(0);
  76:	4501                	li	a0,0
